...
function createWebsite(websiteName) {
	...
	_vinylFs2.default.src(['**/*', '!node_modules/**/*'], {
		...
		_child_process2.default.execSync('cd ' + websiteName + ' && npm i --save react react-dom xr-meta-engine');

		_child_process2.default.execSync('cd ' + websiteName + ' && npm i -- save-dev babel-core \n\t\t\t\t\t\tbabel-loader babel-plugin-add-module-exports \n\t\t\t\t\t\tbabel-plugin-transform-decorators-legacy\n\t\t\t\t\t\tbabel-plugin-transform-runtime\n\t\t\t\t\t\tbabel-preset-es2015\n\t\t\t\t\t\tbabel-preset-react\n\t\t\t\t\t\tbabel-preset-stage-0\n\t\t\t\t\t\tcss-loader\n\t\t\t\t\t\tfile-loader\n\t\t\t\t\t\thtml-webpack-plugin\n\t\t\t\t\t\tless\n\t\t\t\t\t\tless-loader\n\t\t\t\t\t\twebpack\n\t\t\t\t\t\twebpack-dev-server');
	}).resume();
}
