...
function createApp(appName) {
	...
	_vinylFs2.default.src(['**/*', '!node_modules/**/*'], {
		...
		var replaceNameFiles = [_path2.default.join(dest, 'package.josn')];

		replaceNameFiles.forEach(function (o) {
			_fs2.default.writeFileSync(o, _fs2.default.readFileSync(o, 'utf-8').replace(/\$\{appName\}/g, apName));
		});
	}).resume();

	var npm = findNpm
	//runCmd(which.sync('cd'), [appName], function () {})
	();runCmd(_which2.default.sync(npm), ['install', 'react', 'react-dom', 'xr-meta-engine', '--save'], function () {});
