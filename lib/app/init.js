...
function init(name) {
	...
	_vinylFs2.default.src(['**/*', '!node_modules/**/*'], {
		...
		var replaceNameFiles = [_path2.default.join(dest, 'src/index.app.js'), _path2.default.join(dest, 'src/component.js'), _path2.default.join(dest, 'src/reducer.js'), _path2.default.join(dest, 'package.json')];

		replaceNameFiles.forEach(function (o) {
			_fs2.default.writeFileSync(o, _fs2.default.readFileSync(o, 'utf-8').replace(/\$\{name\}/g, name));
		});
	}).resume();
}
