 ...
 */
		...
		return 'import ' + o.name + ' from \'' + _path2.default.relative(_path2.default.join(o.path, 'index.js'), basePath) + '\'';
	}).join('\r\n'
 ...
 */
	...
	var appLessContent = apps.map(function (o) {
		return '@import "' + _path2.default.relative(_path2.default.join(o.path, 'style.less'), _path2.default.join(basePath, 'assets', 'styles', 'app.less')) + '"';
	}).join('\r\n');
