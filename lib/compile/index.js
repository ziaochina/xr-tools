 ...
 */
		...
		return 'import ' + o.name + ' from \'' + _path2.default.relative(basePath, _path2.default.join(o.path, 'index.js')) + '\'';
	}).join('\r\n'
 ...
 */
	...
	var appLessContent = apps.map(function (o) {
		return '@import "' + _path2.default.relative(_path2.default.join(basePath, 'assets', 'styles', 'app.less'), _path2.default.join(o.path, 'style.less')) + '"';
	}).join('\r\n');
